...
class Camera(Base):
    ...
    osd_enabled: Mapped[bool] = mapped_column(Boolean, server_default=text("false"))
    osd_clock: Mapped[bool] = mapped_column(Boolean, server_default=text("true"))
    osd_label: Mapped[bool] = mapped_column(Boolean, server_default=text("true"))
